"""
Django settings for turmoe project.
...
SECRET_KEY = '#f#=k9s%l#4gn*aq!z@@y#o8swyn#z)&8nebu%oh($fjqg)zx0'
...
MIDDLEWARE = [
    'engine.middleware.UrlPatternUpdateMiddleware',
...
WSGI_APPLICATION = 'turmoe.wsgi.application'
